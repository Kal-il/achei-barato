...
from mercado.mercado.usecases import mercado_usecases
from mercado.mercado.use_cases import produto_usecases, api_mercados_usecases, curtidas_usecases, mercado_seguir_usecases
