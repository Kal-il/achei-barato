...
class ProdutoBase(BaseModel):
    ...
    gtin_produto: Optional[str] = Field(..., max_length=14, description="GTIN do produto")
    ...
    imagem: Optional[ImageType] = Field(..., description="Imagem")
    codigo_produto: Optional[str] = Field(..., max_length=30, description="Código do produto")